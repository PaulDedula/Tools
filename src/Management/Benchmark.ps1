# Get-Childitem
## Include switch
$GetChildItem = Measure-Command { Get-Childitem -Path C:\users\pauld\ -Include "*.csv", "*.txt", "*.ps1" -Recurse }
clear-variable -Name res


## Loop through several extensions with Foreach-object
$GetChildItem_Loop = Measure-Command { "*.csv", "*.txt", "*.ps1" | ForEach-Object { Get-Childitem -Path C:\users\pauld\ -Filter $_ -Recurse } }
clear-variable -Name res


## Loop through several extensions with Foreach-object Parallel
$GetChildItem_Loop_Parallel = Measure-Command { "*.csv", "*.txt", "*.ps1" | ForEach-Object -Parallel { Get-Childitem -Path C:\users\pauld\ -Filter $_ -Recurse } }
clear-variable -Name res


# Dir
## loop through several extensions with foreach-object
$dir_loop = Measure-Command { "*.csv", "*.txt", "*.ps1" | ForEach-Object { C:\windows\system32\cmd.exe /c dir /s /b "C:\users\pauld\$_" } }
clear-variable -Name res


## loop through several extensions with foreach-Object parallel
$dir_loop_Parallel = Measure-Command { "*.csv", "*.txt", "*.ps1" | ForEach-Object -parallel { C:\windows\system32\cmd.exe /c dir /s /b "C:\users\pauld\$_" } }
clear-variable -Name res
...
# Get-Files
$GetFiles = measure-Command { Get-Files -Path C:\users\pauld\ -Include "*.csv", "*.txt", "*.ps1" -Recurse }
$GetFiles_Parallel = measure-Command { Get-Files -Path C:\users\pauld\ -Include "*.csv", "*.txt", "*.ps1" -Recurse -Parallel }
